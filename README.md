...
There are a few other places where I have seen other object implemented in Pd and so I have gone ahead and done a few things beyond the scope of the current page in the text. Later, I see a lot of those things get covered anyway. Hopefully, this helps somebody in their work in Pd, in some small way.
